...
GlobeData.Event = function(entryData) {
    ...
    this.publisher = entryData.publisher;
...
GlobeData.AmbientEventView = function(ambientEvent, globeKitView, leftSide) {
    ...
    var __init__ = function() {
        ...
        str = str.replace("{{publisherText}}", ambientEvent.publisher.name);
        str = str.replace("{{eventText}}", ambientEvent.text);
        str = str.replace("{{cityText}}", ambientEvent.origin.name);
